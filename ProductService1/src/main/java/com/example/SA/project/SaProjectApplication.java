...
public class SaProjectApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		ProductDTO productdto=new ProductDTO(1,"Corolla",30000);
		...
		ProductDTO productdto1=new ProductDTO(2,"Infinity",40000);
		...
		ProductDTO productdto2=new ProductDTO(3,"Accord",35000);
		...
		ProductDTO productdto3=template.getForObject(server+"/{productnumber}",ProductDTO.class,2);
		System.out.println(productdto3);

		System.out.println("-------------------------------updateProduct-----------------------------");
		ProductDTO productdto4=template.getForObject(server+"/{productnumber}",ProductDTO.class,1);
		productdto4.setPrice(40000);
		template.put(server+"/{price}",productdto4,40000);
